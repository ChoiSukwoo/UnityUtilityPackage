...
namespace Suk.RestApi
{
	internal static class RestApiPostVideo
	{
		...
		{
			yield return HandleAudioSend(audioData, audioType, headers, (bodyData) => Post<byte[]>(url, bodyData, (res) => HandleVideoResponse(res, savePath, onComplete), onProgress, headers, ContentTypeState.Video, audioType));
		}
