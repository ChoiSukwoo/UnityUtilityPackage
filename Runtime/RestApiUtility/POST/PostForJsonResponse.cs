...
namespace Suk.RestApi
{
	internal static class PostForJsonResponse
	{
		...
		{
			yield return HandleAudioSend(audioData, audioType, headers, (bodyData) => Post<string>(url, bodyData, (res) => HandleJsonResponse(res, onComplete), onProgress, headers, ContentTypeState.Text, audioType));
		}
