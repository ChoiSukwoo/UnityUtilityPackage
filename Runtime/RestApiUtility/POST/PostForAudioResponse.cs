...
namespace Suk.RestApi
{
	internal static class PostForAudioResponse
	{
		...
		public static IEnumerator PostNoneForAudioResponse<T>(string url, AudioContentType audioType = AudioContentType.MP3, UnityAction<ApiResponse<AudioClip>> onComplete = null, UnityAction<float> onProgress = null, Dictionary<string, string> headers = null)
		{
		...
		public static IEnumerator PostTextForAudioResponse<T>(string url, string text, string contentType, AudioContentType audioType = AudioContentType.MP3, UnityAction<ApiResponse<T>> onComplete = null, UnityAction<float> onProgress = null, Dictionary<string, string> headers = null)
		{
		...
		public static IEnumerator PostBinaryForAudioResponse<T>(string url, byte[] binaryData, string contentType, AudioContentType audioType = AudioContentType.MP3, UnityAction<ApiResponse<T>> onComplete = null, UnityAction<float> onProgress = null, Dictionary<string, string> headers = null)
		{
		...
		public static IEnumerator PostJsonForAudioResponse<TSend, T>(string url, TSend body, AudioContentType audioType = AudioContentType.MP3, UnityAction<ApiResponse<T>> onComplete = null, UnityAction<float> onProgress = null, Dictionary<string, string> headers = null)
		{
		...
		public static IEnumerator PostAudioForAudioResponse<T>(string url, byte[] audioData, AudioContentType sendAudioType, AudioContentType receiveAudioType = AudioContentType.MP3, UnityAction<ApiResponse<T>> onComplete = null, UnityAction<float> onProgress = null, Dictionary<string, string> headers = null)
		{
