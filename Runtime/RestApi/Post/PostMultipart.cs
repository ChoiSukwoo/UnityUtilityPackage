...
namespace Suk
{
	internal static class PostMultipart
	{
		...
		public static async UniTask<Texture2D> PostMultipartForTexture(string url, MultipartFormData body, UnityAction<float> onProgress = null, Dictionary<string, string> headers = null, CancellationToken cancellationToken = default)
		{
